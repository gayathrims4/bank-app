...
var banksListComponent = /** @class */ (function () {
    function banksListComponent(bankApi) {
        var _this = this;
        ...
        this.bankApi.GetBanks().subscribe(function (data) {
            _this.BankData = data;
            _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](_this.BankData);
            setTimeout(function () {
                _this.dataSource.paginator = _this.paginator;
            }, 0);
        });
    }
    banksListComponent.prototype.doLike = function (ele) {
        var _this = this;
        var inobj = { ifsc: ele.ifsc, isLiked: ele.isLiked ? false : true };
        this.bankApi.doLike(inobj).subscribe(function (result) {
    ...
    banksListComponent.prototype.searchFfilter = function (val) {
        if (val != "") {
            this.dataSource = val ? this.BankData.filter(function (productlistArray) { return productlistArray.city.toUpperCase() == val.toUpperCase() || productlistArray.address.toUpperCase() == val.toUpperCase() || productlistArray.bank_id == Number(val) || productlistArray.bank_name.toUpperCase() == val.toUpperCase() || productlistArray.branch.toUpperCase() == val.toUpperCase() || productlistArray.district.toUpperCase() == val.toUpperCase() || productlistArray.ifsc.toUpperCase() == val.toUpperCase() || productlistArray.state.toUpperCase() == val.toUpperCase(); }) : this.BankData;
        }
        else {
            this.dataSource = this.BankData;
        }
    };
    banksListComponent.prototype.selectfilter = function (e) {
        if (e.target.value != "all") {
            this.dataSource = e.target.value ? this.BankData.filter(function (productlistArray) { return productlistArray.city.toUpperCase() == e.target.value.toUpperCase(); }) : this.dataSource;
        }
        else {
            this.dataSource = this.BankData;
        }
...
var ApiService = /** @class */ (function () {
    ...
    // Get all students
    ApiService.prototype.GetBanks = function () {
        return this.http.get("api");
    };
    ApiService.prototype.doLike = function (inobj) {
